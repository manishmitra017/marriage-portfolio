...
// ─────────────────────────────────────────────────────────────────────────────
// Ashirwad Ceremony Gallery — Rituparna & Soumya, Kolkata
...
export const blessingPhotos: GalleryPhoto[] = [
  img('001', 'Elder blessing Soumya on the ceremonial carpet', 'A sacred beginning — ashirwad on the carpet'),
  img('002', 'KumKum Ma feeding Soumya sweets during ashirwad', 'KumKum Ma blesses Soumya with sweets'),
  img('007', 'Kaki blessing Soumya', 'Kaki gives her blessings'),
  img('009', 'Elder blessing Soumya with durba grass', 'Blessings with sacred durba grass'),
  img('013', 'Meson Mama feeding Soumya sweets', 'Meson Mama feeds Soumya mishti'),
  ...
  img('031', 'Kaki blessing Soumya during the ceremony', 'Kaki blesses the groom'),
  ...
  img('050', 'Green sari lady blessing Soumya', 'Blessings in green — grace and love'),
  img('055', 'Rituparna touching elder feet for pranam', 'Rituparna seeks blessings with pranam'),
  img('060', 'Soumya receiving blessings bowing head', 'Soumya bows his head for ashirwad'),
  ...
  img('079', 'Soumya Dada blessing Rituparna', 'Soumya\'s Dada blesses Rituparna'),
  img('081', 'Grandfather placing hand on Soumya head', 'A grandfather\'s blessings'),
  ...
  img('098', 'Soumya receiving blessing illuminated by diya', 'Blessings illuminated by the diya'),
  img('100', 'Blessing with diya and durba grass', 'The glow of blessings and sacred flame'),
  img('104', 'Elder blessing and feeding Soumya', 'Fed with love and blessed with grace'),
  img('107', 'Elder blessing couple with garland', 'Garlands of ashirwad'),
  img('109', 'Soumya Ma welcoming Rituparna', 'Soumya\'s Ma welcomes Rituparna'),
  img('112', 'Elder blessing Soumya with both hands', 'Ashirwad from the eldest'),
  img('116', 'Elder tying sacred thread on wrist', 'The sacred thread of blessings'),
  img('129', 'Meson Mama blessing Soumya', 'Meson Mama\'s blessings'),
  img('135', 'Elder putting garland on Soumya', 'Garlanded with blessings'),
  img('145', 'Elder lady blessing Rituparna tenderly', 'Ashirwad for Rituparna'),
  img('147', 'Feeding sweets to Soumya as blessing', 'Mishti and blessings — a Bengali tradition'),
  img('148', 'Soumya touching Ma feet', 'Soumya seeks Ma\'s blessings'),
  img('180', 'Elder man feeding Soumya', 'Fed by the hands of elders'),
  ...
  img('249', 'Red kurta elder blessing Soumya', 'Blessings in red'),
  img('262', 'Elder lady in red sari blessing', 'Blessed by the women of the family'),
];

// ── Section 2: Rituparna & Soumya — Couple Moments (25 photos) ─────────────
export const couplePhotos: GalleryPhoto[] = [
  img('005', 'Rituparna and Soumya reading documents together', 'Reading their future together'),
  ...
  img('044', 'Rituparna and Soumya with garlands exchanged', 'The garland exchange — two hearts, one promise'),
  ...
  img('103', 'Rituparna and Soumya standing together', 'Standing together, ready for forever'),
  ...
  img('127', 'Rituparna and Soumya signing together', 'Signing the next chapter'),
  ...
  img('169', 'Rituparna and Soumya making peace signs', 'Peace, love, and garlands!'),
...
export const signingPhotos: GalleryPhoto[] = [
  img('012', 'Soumya signing documents with Rituparna smiling', 'Making it official — pen meets paper'),
  ...
  img('064', 'Soumya Ma signing papers', 'Soumya\'s Ma signs with a smile'),
  ...
  img('138', 'Soumya signing another document', 'Soumya signs one more'),
...
export const familyPhotos: GalleryPhoto[] = [
  img('000', 'Family group photo with Babai Ma KumKum Ma Rituparna Soumya', 'Babai, Ma, KumKum Ma, Rituparna, Soumya & family'),
  img('003', 'Monalisa and Manish blessing Soumya', 'Didi Monalisa & Manish bless the groom'),
  ...
  img('267', 'Soumya with Dada Dadu Dida and Ma', 'Soumya with Dada, Dadu, Dida & Ma'),
  img('269', 'Mother with Soumya at the front door', 'A mother\'s welcome at the door'),
